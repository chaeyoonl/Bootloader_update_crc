...
#define ETX_APP_FLASH_ADDR        0x08040000   //Application's Flash Address (Sector 6)
#define ETX_APP_SLOT0_FLASH_ADDR  0x08080000   //App slot 0 address	(Sector 8)
#define ETX_APP_SLOT1_FLASH_ADDR  0x080C0000   //App slot 1 address (Sector 10)
