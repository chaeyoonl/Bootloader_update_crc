...
static uint32_t getAppTotalSaize(uint8_t sizse_1, uint8_t sizse_2, uint8_t sizse_3) {
	uint32_t data_len = 0;
...
static uint32_t getCRC(uint8_t crc_1, uint8_t crc_2, uint8_t crc_3, uint8_t crc_4) {
	uint32_t data_len = 0;
